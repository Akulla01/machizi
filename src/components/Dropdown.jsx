import { faSignIn, faUser,faUpload, faAd, faWallet } from '@fortawesome/free-solid-svg-icons';
...
export default function Dropdown() {
  ...
  return (
	<div className='absolute top-[90%] z-10 right-0 bg-light_overlay dark:bg-dark_overlay flex flex-col w-[200px] shadow-md'>
		...
		<Link className='px-4 my-4 w-[90%]  hover:text-accent  font-bold' to="/my-wallet"><FontAwesomeIcon  icon={faWallet}/> my wallet</Link>
		{/* {
			is_token && (
