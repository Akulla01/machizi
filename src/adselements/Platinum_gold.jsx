...
function Platinum_gold() {
  return (
	<div className="w-full sm:w-[80%] flex items-center justify-center flex-col md:flex-row">
		<div className="w-[90%] sm:w-[300px] min-h-[400px] my-4 mx-4 shadow bg-platinum rounded-md p-2 text-grey_light">
			<h1 className="font-bold text-xl sm:text-4xl my-4 text-accent">platinum</h1>
		...
		<div className="w-[90%] sm:w-[300px] min-h-[400px] my-4 mx-4 shadow bg-gold text-grey_light">
			<h1 className="font-bold text-xl sm:text-4xl rounded my-4">gold</h1>
			<span  className="mt-10 font-bold">banner advertisement</span>
			<div className="text-[50px] font-extrabold text-grey_dark">
				ksh.3000
			</div>
